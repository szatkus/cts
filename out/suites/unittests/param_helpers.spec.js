...
`;
import { TestGroup, paramsEquals, pcombine, pexclude, pfilter, poptions } from '../../framework/index.js';
...
g.test('options', t => {
  t.expectSpecEqual(poptions('hello', [1, 2, 3]), [{
    hello: 1
  }, {
    hello: 2
  }, {
...
g.test('combine/mixed', t => {
  t.expectSpecEqual(pcombine(poptions('x', [1, 2]), poptions('y', ['a', 'b']), [{
    p: 4
  }, {
    q: 5
  }], [{}]), [{
...
//# sourceMappingURL=param_helpers.spec.js.map